...
import com.i012114.taller2.Adapters.AdapterCountryDos;
...
import com.i012114.taller2.Parser.JsonCountryDos;
...
public class CountriesActivity extends AppCompatActivity {
    ...
    List<CountryDos> countryDosList;
    AdapterCountry adapterCountry;
    AdapterCountryDos adapterCountryDos;
    ...
    public void processData(){
        ...
        adapterCountryDos = new AdapterCountryDos(countryDosList, getApplicationContext());
        recyclerView.setAdapter(adapterCountryDos);
    }
    ...
    public class TaskCountry extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                countryDosList = JsonCountryDos.getData(s);
